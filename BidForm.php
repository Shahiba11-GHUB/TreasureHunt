...
<form action="submit_bid.php" method="POST">
    ...
    <label>
        <input type="checkbox" id="toggleAddress" onchange="toggleAlternateAddress()"> Ship to a different address
    </label><br><br>

    <div id="altAddressSection" style="display:none;">
        <label>Alternate Shipping Address:</label><br>
        <textarea name="alternateAddress"></textarea><br><br>
    </div>
...
<script>
function toggleAlternateAddress() {
    const altSection = document.getElementById("altAddressSection");
    altSection.style.display = altSection.style.display === "none" ? "block" : "none";
}
</script>
